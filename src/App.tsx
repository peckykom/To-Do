...
import MainStyle from "./styled/Main.styled";
import GlobalStyle from "./styled/Global.styled";
import BannerStyle from "./styled/Banner.styled";
...
const LOCAL_STORAGE_TODOS_KEY = 'todoApp.todos';
